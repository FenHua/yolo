...
def main():
    ...
    parser.add_argument('--weights', default="YOLO_small.ckpt", type=str) #添加参数
    ...
    weight_file = '/home/yhq/Desktop/yolo/data/pascal_voc/weights/YOLO_small.ckpt' # 测试文件，当前目录在此上一层
    ...
    imname = '/home/yhq/Desktop/yolo/test/cat.jpg'
